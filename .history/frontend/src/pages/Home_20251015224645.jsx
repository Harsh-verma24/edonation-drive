        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap justify-between">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-4 text-gray-400 text-sm">We envision a world where resources are shared responsibly, and everyone has access to the essentials they need. Through ReLife, we strive to create a sustainable future by encouraging mindful consumption and generosity.</p>
              <p className="mt-4 text-gray-400 text-sm">Join us in building a community that cares for the planet and its people.</p>
            </div>
          </div>
