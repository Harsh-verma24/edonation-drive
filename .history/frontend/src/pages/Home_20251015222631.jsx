  ...
  return (
    <div className="p-12 bg-gradient-to-r from-green-100 to-blue-100 min-h-screen">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
        <img
          src="https://images.unsplash.com/photo-1508780709619-79562169bc64?ixid=MnwzNjUyOXwwfDF8c2VhcmNofDF8fG1ha2UlMjBhJTIwY2hhbmdlfGVufDB8fHx8MTY5NzQ4NzYwNQ&ixlib=rb-4.0.3&q=80&w=1080"
          alt="Make a Change"
          className="rounded-lg shadow-lg"
        />
        <img
          src="https://images.unsplash.com/photo-1508780709619-79562169bc64?ixid=MnwzNjUyOXwwfDF8c2VhcmNofDF8fGJsdWUlMjBhbmQlMjB3aGl0ZSUyMHRleHRpbGV8ZW58MHx8fHwxNjk3NDg3NjA1&ixlib=rb-4.0.3&q=80&w=1080"
