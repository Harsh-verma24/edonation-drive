        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap justify-between">
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              ...
              <p className="mt-4 text-gray-400 text-sm">ReLife is a platform dedicated to promoting sustainability and generosity. Join us in making a difference by donating reusable items and earning rewards.</p>
            </div>
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
